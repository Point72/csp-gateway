...
class SQLAWriter(GatewayModule):
    """
    The SQLAWriter module allows for formatted writing of items to tables.
    ...
    -------
    ```python
    from csp_gateway.server.modules.sql import SQLACnxDetails, ChannelSchemaConfig, SQLAWriter
    ...
    modules.append(
        SQLAWriter(cnx_details=cnx_details, schema_configs=schema_configs)
    )
    ```
