...
if __name__ == "__main__":
    ...
    # KafkaReadWrite GatewayModule are shown. This allows users
    # to use Kafka to send and receive Gateway channel ticks on
    # Gateway Strcuts.

    # When ran, this file will print a struct called MyStruct,
    # with foo="HELLO WORLD!!" many times. One KafkaReadWrite instance
    ...
    kafka_write_module = KafkaReadWrite(
    ...
    kafka_read_module = KafkaReadWrite(
        config=create_kafka_config(),
